...
export declare class PopupBase extends BaseComponent<MbscPopupOptions, MbscPopupState> {
    ...
    private _vpHeight;
    private _win;
    _setActive: (el: HTMLDivElement) => void;
    _setContent: (el: HTMLDivElement) => void;
    _setLimitator: (el: HTMLDivElement) => void;
    _setPopup: (el: HTMLDivElement) => void;
    _setWrapper: (el: HTMLDivElement) => void;
    ...
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<PopupBase, "[mbsc-popup-b]", never, {}, {}, never, never, false, never>;
}
