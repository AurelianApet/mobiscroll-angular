...
export declare class EventcalendarBase extends BaseComponent<MbscEventcalendarOptions, MbscEventcalendarState> {
    ...
    /** @hidden */
    _timelineResolution: 'year' | 'month' | 'week' | 'day' | undefined;
    /** @hidden */
    ...
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<EventcalendarBase, "[mbsc-ec-b]", never, {}, {}, never, never, false, never>;
}
