...
export declare class SwitchBase extends BaseComponent<MbscSwitchOptions, MbscSwitchState> {
    ...
    _setHandleCont: (span: HTMLSpanElement) => void;
    _setHandle: (span: HTMLSpanElement) => void;
    /**
    ...
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<SwitchBase, "[mbsc-sw-b]", never, {}, {}, never, never, false, never>;
}
